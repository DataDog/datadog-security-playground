...
variable "instance_type" {
  description = "EC2 instance type for the single ECS container instance"
  type        = string
  default     = "t3.medium"
}
...
variable "app_image" {
  description = "Playground application image"
  type        = string
  default     = "docker.io/datadog/datadog-security-playground:latest"
}
