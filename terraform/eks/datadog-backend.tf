# Backend detection rules: run in the Datadog backend, not the agent.
# Requires security_monitoring_rules_write on the application key.

# Correlates cryptomining indicators and IMDSv2 credential resolution
# (imds_v2_tracking) within the same execution context.
