# test-api-client
A client library for accessing AppSec Test API

## Usage
First, create a client:

```python
from test_api_client import Client
...
```python
from test_api_client import AuthenticatedClient
...
```python
from test_api_client.models import MyDataModel
from test_api_client.api.my_tag import get_my_data_model
from test_api_client.types import Response
...
1. Any endpoint which did not have a tag will be in `test_api_client.api.default`
