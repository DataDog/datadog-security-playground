...
require (
	github.com/DataDog/dd-trace-go/contrib/net/http/v2 v2.10.0-rc.1.0.20260708135804-c8b3f24a6a8d
	github.com/DataDog/dd-trace-go/v2 v2.10.0-rc.1.0.20260708135804-c8b3f24a6a8d
