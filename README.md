...
export DD_APP_KEY=<your application key>      # needed for scenario 1 (rce-malware) and the Terraform Datadog rules; requires security_monitoring_rules_write and security_monitoring_cws_agent_rules_write scopes
```
